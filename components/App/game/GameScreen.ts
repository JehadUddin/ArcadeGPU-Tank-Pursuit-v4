  ...
  update(ts: number) {
    ...
    if (this.isPlayerInTank) {
      ...
      if (didShoot) {
         ...
         const scaleMultiplier = didShoot === 'grenade' ? 2.0 : 1.0;
         this.explosions.push(new Explosion(muzzlePos[0], muzzlePos[1], muzzlePos[2], muzzleColor, dir, scaleMultiplier, didShoot === 'grenade' ? 'grenade' : 'muzzle'));
      }
